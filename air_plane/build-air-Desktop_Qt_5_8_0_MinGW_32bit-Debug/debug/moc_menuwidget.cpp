...
#include "../../air_plane/menuwidget.h"
...
QT_MOC_LITERAL(3, 24, 8), // "sig_quit"
QT_MOC_LITERAL(4, 33, 8), // "slt_quit"
QT_MOC_LITERAL(5, 42, 11) // "slt_newGame"

    },
    "MenuWidget\0sig_newGame\0\0sig_quit\0"
    "slt_quit\0slt_newGame"
};
...
void MenuWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MenuWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MenuWidget::sig_quit)) {
                *result = 1;
                return;
            }
        }
